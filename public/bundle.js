...
var FETCH_PAIRINGS = 'FETCH_PAIRINGS';
var UPDATE_PAIRINGS = 'UPDATE_PAIRINGS';
...
var App = {
  ...
  update: function update(model, action) {
    ...
    switch (action.type) {
      case UPDATE_PAIRINGS:
        var pairings = action.pairings;
        var _model = { pairings: pairings };
        return { model: _model };
      default:
        return _model;
    }
  ...
  view: function view(model, dispatch) {
    return (0, _inu.html)(_templateObject, model.pairings.map(function (p) {
      return (0, _inu.html)(_templateObject2, p.Table, p.Player.replace(/,.*/, ''), p.Player.replace(/[^,]*,/, ''));
    }));
  },

  run: function run(effect) {
    var _ret = function () {
      switch (effect.type) {

        case FETCH_PAIRINGS:
          var source = _pullDefer2.default.source();

          _xhr2.default.get('/data', function (err, res) {
            if (err) console.log(err);

            var model = JSON.parse(res.body);
            var pairings = model.pairings;

            source.resolve(_inu.pull.values([{
...
var _start = (0, _inu.start)(_App2.default);

var views = _start.views;

var main = document.querySelector('.main');

(0, _inu.pull)(views(), _inu.pull.drain(function (view) {
  _inu.html.update(main, view);
}));
//})
